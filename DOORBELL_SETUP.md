...
- **URL**: `http://192.168.0.199:8765/doorbell-webhook` (update with your server IP)
- **Method**: `POST`
...
1. Start a test call: `curl -X GET http://192.168.0.199:8765/test-call`
2. Try saying "goodbye" - it should be ignored
3. Manually activate doorbell: `curl -X POST http://192.168.0.199:8765/activate-doorbell`
